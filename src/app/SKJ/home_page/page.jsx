...
export default function HomePage() {
    return (
        <div className="p-[18px] bg-white h-screen w-screen overflow-auto">
            ...
            <div className="h-10 pt-[24px] text-center text-gray-800 text-2xl font-extrabold leading-10 drop-shadow-xl">Lab Sistem Komputer dan Jaringan</div>



            <Link href="/SKJ/pendatang_page">
