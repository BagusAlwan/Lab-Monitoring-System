...
export default function NonAnggotaPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const verificationResponse = await fetch(`http://10.6.43.100:8080/verify/RPLD/${nama}/${encodedNIM}`); // Adjust the URL accordingly
      ...
      if (verificationResponse.ok) {
        ...
        if (verificationData.verified) {
          ...
          const postResponse = await fetch('/api/RPLD/sheetsRPLD', {
            method: 'POST',
            headers: {
